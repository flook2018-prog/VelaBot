    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#f0f2f5] to-[#ffe082] px-2">
      {!loggedIn && (
        <form
          ...
          autoComplete="on"
        >
          <img src="/cash-payment.png" alt="Logo" className="login-logo w-16 h-16 object-contain mb-4 rounded-3xl shadow-lg border-4 border-[#fffbe7] bg-[#fffbe7]" style={{boxShadow:'0 4px 16px rgba(108,52,131,0.10)'}} />
